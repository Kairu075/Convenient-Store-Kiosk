...
public class PersonalCarePage extends JFrame {
    ...
    private String currentCategory = "Bath & Body";
    private final DecimalFormat priceFormat = new DecimalFormat("0.00");
    
    // UI Constants
    private final Color PRIMARY_COLOR = new Color(26, 188, 156); // Teal/mint theme for personal care
    private final Color ACCENT_COLOR = new Color(22, 160, 133);
    ...
    private void initProducts() {
        ...
        products.put("Skin Care", Arrays.asList(
            "Face Wash", "Moisturizer", "Sunscreen", "Face Mask", "Serum"
        ));
    ...
    private JPanel createHeaderPanel() {
        ...
        JLabel titleLabel = new JLabel("Personal Care & Hygiene", SwingConstants.LEFT);
    ...
    private JPanel createSubcategoryPanel() {
        ...
        bathButton = createCategoryButton("Bath & Body", "🛁");
        hairButton = createCategoryButton("Hair Care", "💇");
        oralButton = createCategoryButton("Oral Care", "🦷");
        skinButton = createCategoryButton("Skin Care", "💆");
        
        subcategoryPanel.add(bathButton);
        subcategoryPanel.add(hairButton);
        subcategoryPanel.add(oralButton);
        subcategoryPanel.add(skinButton);
